...
# The key is that master means the main project.
# But if we want to develop other projects, we should start other branches.
# 1. git status                     --- it indicate the change/status about your current folder files 
